...
def get_args():
    ...
    parser.add_argument('--dl-bbp-T', type=int, default=5,
                        help='set the number of backpropagations when performing BBP for variational BNN')
    parser.add_argument('--dl-prior-sig', type=float, default=1,
    ...
    parser.add_argument('--exp-name', type=str, default=None,
                        choices=['gmm', 'bnn'],
                        help='choose which experiment to conduct')
    parser.add_argument('--exp-type', type=str, default=None,
                        choices=['burn-in-remain', 'forget'],
                        help='choose which type of experiment to conduct: train or forget')
    parser.add_argument('--is-vi', action='store_true',
                        help='select to conduct variational inference')
    parser.add_argument('--arch', type=str, default=None,
                        choices=['gmm', 'mlp', 'lenet'],
                        help='choose the model architecture')
    parser.add_argument('--dataset', type=str, default=None,
                        choices=['gmm2d', 'mnist', 'fashion-mnist', 'cifar10'],
    ...
    parser.add_argument('--mcmc-samp-num', type=int, default=0,
                        help='set how many number of points to draw in the MCMC GMM experiment')
